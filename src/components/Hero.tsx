  ...
  return (
    <section id="hero" ref={heroRef} className="relative h-[60vh] flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          ...
          >
            {"Новопольские"}
            <br />
            <span className="text-orange-200">{"Баньки"}</span>
          </h1>
        </div>
      </div>
      ...
      <div className="absolute inset-0 z-20 pointer-events-none">
        <img
          src="https://cdn.poehali.dev/projects/38fef863-0ec5-41e7-86f6-9085d36307b9/bucket/cb24813c-23a1-4998-bf7d-e43fa77d37ee.jpeg"
          alt="Новогоднее украшение бани"
          className="w-full h-full object-cover object-center"
        />
      </div>
